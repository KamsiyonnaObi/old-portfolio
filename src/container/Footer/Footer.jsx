...
const Footer = () => {
  ...
  return (
    <>
      <h2 className="head-text">Let's chat over coffee ☕️</h2>
      <div className="app__footer-cards">
        <div className="app__footer-card">
          <img src={images.email} alt="email" />
          <a href="mailto:obikamsi@gmail.com" className="p-text">obikamsi@gmail.com</a>
        </div>

        <div className="app__footer-card">
          <img src={images.mobile} alt="mobile" />
          <a href="tel:+1 (204) 396-5056" className="p-text">+1 (204) 396-5056</a>
        </div>
      </div>  
